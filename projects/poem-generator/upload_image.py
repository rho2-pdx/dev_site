    ...
    def post(self):
        ...
        if '.' in image.filename:
            ...
            if ext not in valid_extensions:
                return render_template('upload_image.html', error="File type not allowed. Please upload an image.")
        ...
        return render_template('label_display.html', labels=labels, poem=poem, audio_file=audio_file)